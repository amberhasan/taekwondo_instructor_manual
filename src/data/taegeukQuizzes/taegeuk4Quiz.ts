const taegeuk4Quiz = [
  ...
  {
    question: 'What is the significance of the number four in Taegeuk Sa Jang?',
    options: [
  ...
  {
    question: 'What is the name of the hand technique used in Taegeuk Sa Jang?',
    options: ['Spearhand', 'Knifehand', 'Fingertip Strike', 'Punch'],
    correctAnswerIndex: 2,
  },
];

export default taegeuk4Quiz;
