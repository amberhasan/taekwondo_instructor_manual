const taegeuk5Quiz = [
  ...
  {
    question: 'What is the significance of the number five in Taegeuk O Jang?',
    options: [
  ...
  {
    question: 'What is the name of the hand technique used in Taegeuk O Jang?',
    options: ['Knifehand Strike', 'Spearhand', 'Elbow Strike', 'Hammerfist'],
    correctAnswer: 1,
  },
];

export default taegeuk5Quiz;
