const palgwaeQuizSet = [
  {
    palgwae1: [
      {
        question: 'What is the other name for Taegeuk 1?',
        options: ['Il-Jang', 'Ee-Jang', 'Sam-Jang', 'O-Jang'],
        correctAnswerIndex: 0, // Index of the correct answer in the options array
      },
      {
        question:
          'Taegeuk 1 serves as the foundation for beginners in Taekwondo, teaching them what fundamental skills?',
        options: [
      ...
      {
        question:
          'In Taegeuk 1, how many movements or steps are there in total?',
        options: ['12', '18', '8', '20'],
        correctAnswerIndex: 0,
      },
      {
        question:
          'What is the primary purpose of Taegeuk 1 in Taekwondo training?',
        options: [
      ...
      {
        question:
          'Which color belt is typically worn by students who have learned Taegeuk 1?',
        options: ['Red belt', 'Green belt', 'Black belt', 'White belt'],
        correctAnswerIndex: 3,
      },
      {
        question: 'True or False: Taegeuk 1 is an advanced form in Taekwondo.',
        options: ['True', 'False'],
        correctAnswerIndex: 1,
      },
      {
        question:
          'In Taegeuk 1, what is the primary focus of the practitioner during the form?',
        options: [
      ...
      {
        question:
          'What does "Taegeuk" represent in the context of Taekwondo forms?',
        options: [
      ...
      {
        question:
          'Which series of forms follows the Taegeuk series in Taekwondo?',
        options: [
          'Koryo series',
          'Hwarang series',
          'Palgwae series',
      ...
      {
        question: 'What is the primary goal when performing Taegeuk 1?',
        options: [
  ...
  },
  {
    palgwae2: [
      ...
      {
        question:
          'Taegeuk 2 emphasizes the development of which fundamental skill?',
        options: [
          'A) Advanced kicks',
      ...
      {
        question:
          'In Taegeuk 2, how many movements or steps are there in total?',
      ...
      {
        question:
          'What is the primary focus of Taegeuk 2 in Taekwondo training?',
        options: [
      ...
      {
        question:
          'In Taegeuk 2, what is the primary focus of the practitioner during the form?',
        options: [
      ...
      {
        question:
          'What is the significance of the "Taegeuk" series in Taekwondo?',
        options: [
    ...
    palgwae3: [
      ...
      },
      {
        ...
        options: [
          ...
          'Three famous mountains in Korea',
          'Three-legged race in Korean culture',
        ],
        correctAnswerIndex: 0,
      },
    ],
